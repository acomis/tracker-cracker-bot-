...
MORNING_QUESTIONS = [
    ("morning_notes",         "📝 Что важно отметить с утра?"),
...
EVENING_QUESTIONS = [
    ("best_moment",           "🌟 Лучший момент дня"),
    ("worst_moment",          "😞 Самый сложный момент дня"),
    ("evening_notes",         "📝 Что ещё важно отметить про день?"),
    ...
    ("intimacy_desire",       "❤️ Желание нежности / контакта (1–10)"),
]
